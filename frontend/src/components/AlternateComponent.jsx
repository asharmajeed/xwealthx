...
function AlternateComponent({ subject }) {
  ...
  const handleStartQuiz = () => {
    ...
    if (subject === "GP") {
      navigate("/general-principle-quiz");
    } else if (subject === "RM") {
      navigate("/risk-management-quiz");
    } else if (subject === "IP") {
      navigate("/investment-planning-quiz");
    } else if (subject === "TP") {
      navigate("/tax-planning-quiz");
    } else if (subject === "RS") {
      navigate("/retirement-quiz");
    } else if (subject === "EP") {
      navigate("/estate-planning-quiz");
    }
  };
  ...
  return (
    <div className="AlternateComponent">
      <div className="header">
        ...
        {subject === "RM" && <h2>Risk Management and Insurance Planning</h2>}
        {subject === "IP" && <h2>Investment Planning</h2>}
        {subject === "TP" && <h2>Tax Planning</h2>}
        {subject === "RS" && <h2>Retirement Savings and Income Planning</h2>}
        {subject === "EP" && <h2>Estate Planning</h2>}
